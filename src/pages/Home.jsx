  ...
  useEffect(() => {
    const fetchFeaturedImages = async () => {
      ...
      try {
        ...
        const images = data.flatMap((property) =>
          property.images.map((image) => image.asset.url)
        );
    ...
    >
      ...
      {activeSection === "home" ? (
        <>
          ...
          {/* About Section */}
          <section
            className={`container pt-4 pb-2 mb-0 mx-auto px-4 ${
            ...
            <div className="lg:w-4/6 mx-auto px-2">
              <div className="flex flex-col sm:flex-row px-4">
                <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8 px-2">
                  <div
                    className={`w-24 h-24 rounded-full inline-flex items-center justify-center ${
                  ...
                  <div className="flex flex-col items-center text-center justify-center mt-4">
                    ...
                    <p className="text-base">
                      I Am A Real-Estate Agent Who Has Been In Business Since
                      2012, With Many Successful Deals With Various Clients.
                    </p>
                  </div>
                </div>
                <div
                  ...
                  } sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left px-2`}
                >
                  <p className="leading-relaxed text-lg mb-4">
                    I am a licensed professional working with property channel
                    partners working in Surat, Gujarat. Best known for renting
                    and selling properties in Surat - Athwalines, Ghod Dod,
                    Bhatar, Vesu, Pal Adajan, Jahangirpura.
                  </p>
                  <p className="leading-relaxed text-lg mb-4">
          ...
          <section
            className={`body-font ${isDarkMode ? "bg-gray-900" : "bg-white"}`}
          >
            <div
              className={`container px-5 py-6 mx-auto flex flex-wrap ${
                isDarkMode ? "text-gray-300" : "text-gray-800"
              }`}
            >
              ...
              <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
                <div className="flex flex-col mb-10 lg:items-start items-center">
                  ...
                  <div className="flex-grow">
                    ...
                    >
                      I have been in business since 2012 and have been providing
                      great service with many happy customers.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col mb-10 lg:items-start items-center">
                  ...
                  <div className="flex-grow">
                    ...
                    >
                      Get your properties sold or bought with trustworthy
                ...
                <div className="flex flex-col mb-10 lg:items-start items-center">
                  ...
                  <div className="flex-grow">
                    ...
                    >
                      We are here to provide what your dream is, no matter how
                      small or how big.
                    </p>
                  </div>
                </div>
